...
/**
 * Also referred to as Devicetree Blob (DTB). It is a flat binary encoding of
 * data (primarily devicetree data, although other data is possible as well).
 ...
 * 
 * @see <a href=
 *      "https://devicetree-specification.readthedocs.io/en/v0.3/flattened-format.html">Source</a>
 * @see <a href=
 *      "https://elinux.org/images/f/f4/Elc2013_Fernandes.pdf">Source</a>
 */
public class Dtb extends KaitaiStruct {
	...
	public enum Fdt {
		...
		public static Fdt byId(long id) {
			return byId.get(id);
		}
	}
	...
	public static class MemoryBlock extends KaitaiStruct {
		...
		public ArrayList<MemoryBlockEntry> entries() {
			return entries;
		}
	...
	public static class FdtBlock extends KaitaiStruct {
		...
		public ArrayList<FdtNode> nodes() {
			return nodes;
		}
	...
	public static class MemoryBlockEntry extends KaitaiStruct {
		...
		public Dtb.MemoryBlock _parent() {
			return _parent;
		}
	}
	...
	public static class Strings extends KaitaiStruct {
		...
		private void _read() {
			this.strings = new ArrayList<String>();
			{
				while (!this._io.isEof()) {
					this.strings.add(
							new String(this._io.readBytesTerm((byte) 0, false, true, true), Charset.forName("ASCII")));
				}
			}
		}
	...
	public long ofsStructureBlock() {
		return ofsStructureBlock;
	}

	public long ofsStringsBlock() {
		return ofsStringsBlock;
	}

	public long ofsMemoryReservationBlock() {
		return ofsMemoryReservationBlock;
	}
	...
	public long minCompatibleVersion() {
		return minCompatibleVersion;
	}

	public long bootCpuidPhys() {
		return bootCpuidPhys;
	}

	public long lenStringsBlock() {
		return lenStringsBlock;
	}

	public long lenStructureBlock() {
		return lenStructureBlock;
	}
	...
	public byte[] _raw_memoryReservationBlock() {
		return _raw_memoryReservationBlock;
	}

	public byte[] _raw_structureBlock() {
		return _raw_structureBlock;
	}

	public byte[] _raw_stringsBlock() {
		return _raw_stringsBlock;
	}
}
